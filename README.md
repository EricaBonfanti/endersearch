...
<img src="https://img.shields.io/badge/Front--end-HTML%20%7C%20CSS%20%7C%20JS-00FF00?style=for-the-badge&logo=javascript&logoColor=00FF00&labelColor=000000" alt="Tecnologias Front-end">
<img src="https://img.shields.io/badge/Back--end-PHP-00FF00?style=for-the-badge&logo=php&logoColor=00FF00&labelColor=000000" alt="Tecnologia Back-end PHP">
<img src="https://img.shields.io/badge/Banco%20de%20Dados-MySQL-00FF00?style=for-the-badge&logo=mysql&logoColor=00FF00&labelColor=000000" alt="Banco de Dados MySQL"> </div>
...
A comunidade de jogadores de Minecraft frequentemente enfrenta dificuldades ao lidar com diferentes tipos de mobs, especialmente os mais perigosos e raros. Informações sobre fraquezas, comportamentos e estratégias de combate estão dispersas em diversos sites e fóruns. Essa fragmentação dificulta o acesso rápido a dados confiáveis, e foi com esse foco que desenvolvi o protótipo:


🟩 O Ender Search é a nossa resposta a essa necessidade, oferecendo promp local sobre todos os mobs hostis do Minecraft.
...
📖 Manual do Usuário - Ender Search

Acesse o guia completo para dominar o Ender Search e encontrar o caminho para a vitória contra qualquer mob!
...
Esta é a tela de boas-vindas da plataforma Ender Search. A página passa uma identidade aventureira, mostrando que a plataforma é uma companheira para a jornada de derrotar qualquer mob hostil.
...
2. Página de Pesquisa (Catálogo de Mobs )


Nesta seção, você tem acesso à barra de pesquisa, o ponto de partida ideal para sua investigação. Abaixo, é apresentada uma galeria completa que exibe todos os mobs hostis do Minecraft, cada um identificado com seu nome, descrição e imagem correspondente, para que você possa localizá-los e estudá-los rapidamente.
...
3. Realizando a Pesquisa (Variantes )


Ao utilizar a barra de pesquisa para digitar o nome de um mob, o sistema exibirá automaticamente todas as suas variantes. Por exemplo, se você pesquisar por 'Esqueleto', serão listados todos os tipos de esqueletos presentes na biblioteca.
...
4. Conferindo as Informações (Fraquezas e Estratégias )


Selecione seu alvo! Um retângulo informativo se abrirá com todos os dados cruciais: suas principais fraquezas, como ele se comporta em combate e as melhores estratégias para você traçar o caminho da vitória.
